...
(function () {
  ...
  /* ===================================================================
     BUILDING PICKER
     -------------------------------------------------------------------
     Click the map, get the building under the click. The picker resolves
     the footprint from OpenStreetMap (Overpass) in *your* browser, so the
     result carries a real OSM id, a real height and a real name — which is
     exactly what data/figure.json needs. "Copy GeoJSON" puts ready-made
     features on your clipboard; paste them to me and they go straight in.
     =================================================================== */
