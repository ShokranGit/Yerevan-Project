...
(function () {
  ...
  en: {
    ...
    "mode.title": "Site mode",
    "mode.dissertation": "The Dissertation",
    "mode.atlas": "The Atlas",
    "mode.dissertationNote": "A selective reading surface for the three article dissertation.",
    "mode.atlasNote": "The full research atlas: open, cumulative, and ready for future Armenia and South Caucasus work.",
    "articles.title": "Articles",
    "articles.all": "All three",
    "articles.allSub": "The dissertation as one argument",
    "articles.one": "Article 1",
    "articles.oneSub": "Northern Avenue, urban transformation, everyday public space",
    "articles.two": "Article 2",
    "articles.twoSub": "System of a Down, commemoration, Republic Square, diaspora",
    "articles.three": "Article 3",
    "articles.threeSub": "The 2018 revolution, Karabakh, political geography",
    "contexts.title": "Context layers",
    "contexts.city": "The City",
    "contexts.citySub": "Places, monuments, squares, streets",
    "contexts.models": "The Models",
    "contexts.modelsSub": "Political landscape and relational graph",
    "contexts.world": "Armenian World",
    "contexts.worldSub": "Diaspora, routes, displacement, return",
    "themes": "Themes",
    "cat.all": "all themes",
    "cat.none": "no themes",
    "cat.some": "{n} of {total}",
    ...
    "cube.many": "Space-time maps",
    "cube.manyRuler": "The labelled ruler belongs to",
    "cube.manyBody": "Several periods are standing at once. Each keeps its own time axis, from its own first day to its own last, so a tall cube is a long period and not a busier one: heights are not comparable between them. What is comparable is the ground, which is the city they share.",
  ...
  hy: {
    ...
    "cube.many": "Տարածաժամանակային քարտեզներ",
    "cube.manyRuler": "Նշագրված քանոնը պատկանում է՝",
    "cube.manyBody": "Միաժամանակ կանգնած են մի քանի ժամանակահատված։ Յուրաքանչյուրը պահում է իր սեփական ժամանակի առանցքը՝ իր առաջին օրվանից մինչև իր վերջինը, ուստի բարձր խորանարդը երկար ժամանակահատված է, ոչ թե ավելի խիտը. բարձրությունները համեմատելի չեն։ Համեմատելին հողն է՝ քաղաքը, որ նրանք կիսում են։",
  ...
  fa: {
    ...
    "cube.many": "نقشه‌های زمان-مکان",
    "cube.manyRuler": "خط‌کشِ برچسب‌خورده از آنِ",
    "cube.manyBody": "چند دوره هم‌زمان سرِ پا ایستاده‌اند. هر کدام محور زمانی خودش را نگه می‌دارد، از نخستین روز خودش تا آخرین روز خودش، پس مکعب بلند یعنی دورهٔ بلند، نه دورهٔ شلوغ‌تر: بلندی‌ها با هم سنجیدنی نیستند. آنچه سنجیدنی است زمین است، شهری که میانشان مشترک است.",
